...
`;var mt;!function(t){t.Full="full",t.Compact="compact"}(mt||(mt={}));const gt=JSON.parse('{"rE":"2026.7.0-beta1"}');class ft{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class yt extends ft{constructor(t){if(super(t),this.it=F,2!==t.type)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===F||null==t)return this._t=void 0,this.it=t;if(t===Q)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}yt.directiveName="unsafeHTML",yt.resultType=1;const vt=(t=>(...e)=>({_$litDirective$:t,values:e}))(yt),_t="flower-card",bt=["moisture","conductivity","temperature","illuminance","humidity","dli"],$t=[{label:"Moisture",value:"moisture"},{label:"Conductivity",value:"conductivity"},{label:"Temperature",value:"temperature"},{label:"Illuminance",value:"illuminance"},{label:"Humidity",value:"humidity"},{label:"Daily Light Integral",value:"dli"},{label:"DLI (24h rolling)",value:"dli_24h"},{label:"CO2",value:"co2"},{label:"Soil Temperature",value:"soil_temperature"},{label:"VPD",value:"vpd"}],wt=[{label:"Watering",value:"care_watering"},{label:"Sunlight",value:"care_sunlight"},{label:"Soil",value:"care_soil"},{label:"Pruning",value:"care_pruning"},{label:"Fertilization",value:"care_fertilization"}],xt={care_watering:"mdi:watering-can-outline",care_sunlight:"mdi:white-balance-sunny",care_soil:"mdi:shovel",care_pruning:"mdi:content-cut",care_fertilization:"mdi:bottle-tonic-outline"};var At,Mt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(At||(At={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Mt||(Mt={})),new Set(["fan","input_boolean","light","switch","group","automation"]);new Set(["call-service","divider","section","weblink","cast","select"]);const Et=(t,e)=>{((t,e,i,s)=>{s=s||{},i=i??{};const o=new Event(e,{bubbles:void 0===s.bubbles||s.bubbles,cancelable:Boolean(s.cancelable),composed:void 0===s.composed||s.composed});o.detail=i,t.dispatchEvent(o)})(t,"hass-more-info",{entityId:e},{bubbles:!1,composed:!0})},St=t=>{var e;return null!==(e=null==t?void 0:t.startsWith("media-source://"))&&void 0!==e&&e},Dt=(t,e)=>t&&e&&0!==e.length?wt.filter(t=>e.includes(t.value)).map(e=>({key:e.value,label:e.label,icon:xt[e.value],text:t[e.value]})).filter(t=>"string"==typeof t.text&&""!==t.text.trim()):[],Ct=t=>B`
    ${t.map(t=>B`
        <div class="care-item">
    ...
    `)}
`,Nt="Care",It=t=>{var e;return null!==(e=t.fields)&&void 0!==e?e:wt.map(t=>t.value)},Lt=t=>{var e;const i=null===(e=t.config)||void 0===e?void 0:e.extra_badges;return i&&0!==i.length?i.map(e=>((t,e)=>{var i;if((t=>"care_info"===t.type)(e))return((t,e)=>{const{icon:i,color:s,tip:o}=(t=>{var e,i,s;return{icon:null!==(e=t.icon)&&void 0!==e?e:"mdi:sprout",color:null!==(i=t.color)&&void 0!==i?i:"var(--secondary-text-color)",tip:null!==(s=t.title)&&void 0!==s?s:Nt}})(e);return B`
    ...
    `})(t,e);if(e.text){const t="none"===(null===(i=e.icon)||void 0===i?void 0:i.toLowerCase()),s=e.color||"var(--secondary-text-color)";if(t&&e.show_state)return B`
        ...
        <div class="extra-badge tooltip" @click="${e=>{e.stopPropagation(),Et(t,s)}}">
    ...
    `})(t,e)):B``};var Ot=function(t,e,i,s){var o,r=arguments.length,n=r<3?e:null===s?s=Object.getOwnPropertyDescriptor(e,i):s;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,i,s);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(n=(r<3?o(n):r>3?o(e,i,n):o(e,i))||n);return r>3&&n&&Object.defineProperty(e,i,n),n},jt=function(t,e,i,s){return new(i||(i=Promise))(function(o,r){function n(t){try{l(s.next(t))}catch(t){r(t)}}function a(t){try{l(s.throw(t))}catch(t){r(t)}}function l(t){var e;t.done?o(t.value):(e=t.value,e instanceof i?e:new i(function(t){t(e)})).then(n,a)}l((s=s.apply(t,e||[])).next())})};console.info(`%c FLOWER-CARD %c ${gt.rE}`,"color: cyan; background: black; font-weight: bold;","color: darkblue; background: white; font-weight: bold;"),window.customCards=window.customCards||[],window.customCards.push({type:_t,name:"Flower card",preview:!0,description:"Custom flower card for https://github.com/Olen/homeassistant-plant",getEntitySuggestion:(t,e)=>"plant"!==e.split(".")[0]?null:[{label:"Full",config:{type:`custom:${_t}`,entity:e}},{label:"Compact",config:{type:`custom:${_t}`,entity:e,display_type:mt.Compact}}]});let Ut=class extends at{constructor(){super(...arguments),this._careDialogOpen=!1,this._careDialogFields=[],this._careDialogTitle="Care",this._imageDialogOpen=!1,this.previousFetchDate=0,this.plantinfo={result:{}}}set hass(t){var e,i;this._hass=t,this.stateObj=(null===(e=this.config)||void 0===e?void 0:e.entity)?t.states[this.config.entity]:void 0;const s=null===(i=this.stateObj)||void 0===i?void 0:i.attributes.entity_picture;s!==this._lastEntityPicture&&(this._lastEntityPicture=s,this._resolveEntityPicture(t,s)),Date.now()>this.previousFetchDate+1e3&&(this.previousFetchDate=Date.now(),this.get_data(t).then(()=>{this.requestUpdate()}))}_resolveEntityPicture(t,e){return jt(this,void 0,void 0,function*(){e?St(e)?(this._resolvedImageUrl=yield((t,e)=>function(t,e,i,s){return new(i||(i=Promise))(function(o,r){function n(t){try{l(s.next(t))}catch(t){r(t)}}function a(t){try{l(s.throw(t))}catch(t){r(t)}}function l(t){var e;t.done?o(t.value):(e=t.value,e instanceof i?e:new i(function(t){t(e)})).then(n,a)}l((s=s.apply(t,e||[])).next())})}(void 0,void 0,void 0,function*(){if(!St(e))return e;try{return(yield t.callWS({type:"media_source/resolve_media",media_content_id:e})).url}catch(t){return console.error("Failed to resolve media source:",t),""}}))(t,e),this.requestUpdate()):this._resolvedImageUrl=e:this._resolvedImageUrl=void 0})}static getConfigForm(){return{schema:[{name:"entity",required:!0,selector:{entity:{domain:"plant"}}},{name:"name",selector:{text:{}}},{name:"battery_sensor",selector:{entity:{domain:"sensor",device_class:"battery"}}},{type:"expandable",name:"",title:"Bars",schema:[{name:"show_bars",selector:{select:{multiple:!0,options:$t}}}]},{type:"expandable",name:"",title:"Care Info",schema:[{name:"show_care",selector:{select:{multiple:!0,options:wt}}}]},{type:"expandable",name:"",title:"Appearance",schema:[{name:"display_type",selector:{select:{options:[{value:"full",label:"Full"},{value:"compact",label:"Compact"}]}}},{name:"hide_species",selector:{boolean:{}}},{name:"hide_image",selector:{boolean:{}}},{name:"hide_units",selector:{boolean:{}}}]}],computeLabel:t=>({entity:"Entity",name:"Display Name",display_type:"Display Type",battery_sensor:"Battery Sensor",show_bars:"Show Bars",show_care:"Show Care Info",hide_species:"Hide Species",hide_image:"Hide Image",hide_units:"Hide Units"}[t.name]||t.name)}}static getStubConfig(t){const e=t=>"object"==typeof t&&null!==t&&"entity_id"in t&&"string"==typeof t.entity_id&&t.entity_id.startsWith("plant.");let i=[];try{i=Object.values(t.states).filter(e)}catch(t){console.info(`Unable to get ha-data: ${t}`)}return{entity:i.length>0?i[0].entity_id:"plant.my_plant",battery_sensor:"sensor.myflower_battery",show_bars:bt}}setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this.config=t}openCareDialog(t){const{open:e,fields:i,title:s}=(t=>{var e;return{open:!0,fields:It(t),title:null!==(e=t.title)&&void 0!==e?e:Nt}})(t);this._careDialogFields=i,this._careDialogTitle=s,this._careDialogOpen=e}_closeCareDialog(){this._careDialogOpen=!1}renderCareDialog(){var t,e,i;const s=null===(t=this.config)||void 0===t?void 0:t.entity,o=s?null===(i=null===(e=this._hass)||void 0===e?void 0:e.states[s])||void 0===i?void 0:i.attributes:void 0,r=Dt(o,this._careDialogFields);return B`
            <ha-dialog open heading="${this._careDialogTitle}" @closed="${()=>this._closeCareDialog()}">
                ${r.length>0?B`<div class="care-info care-info--dialog">${Ct(r)}</div>`:B`<div class="care-info-empty">No care information available.</div>`}
            </ha-dialog>
        ...
        `}render(){var t,e;if(!this.config||!this._hass)return B``;if(!this.stateObj)return this._careDialogOpen=!1,this._imageDialogOpen=!1,B`
            ...
            <ha-card class="${c}">
            <div class="${l}${n?" no-image":""}" @click="${()=>Et(this,i.entity_id)}">
                ${n?"":B`<img
    ...
    `})(this)}</span>
        ...
        <div class="${`attribute tooltip ${w?"width-100":""}${w&&$?" has-units":""}`}" @click="${()=>Et(t,e.sensor)}">
            ...
            ${$?B`<div class="header"><span class="value">${g}</span>&nbsp;<span class='unit'>${vt(v)}</span></div>`:""}
        </div>
    `})(t,e)}`:"")}</div>`).flat()})(t,s)})(this)}
            ${(t=>{var e;const i=t.config;if(!i)return B``;const s=i.entity,o=s?null===(e=t._hass.states[s])||void 0===e?void 0:e.attributes:void 0,r=Dt(o,i.show_care);return 0===r.length?B``:B`
        <div class="care-info">
            ${Ct(r)}
        </div>
    `})(this)}
            ...
            `}get_data(t){return jt(this,void 0,void 0,function*(){var e,i;try{this.plantinfo=yield t.callWS({type:"plant/get_info",entity_id:null===(e=this.config)||void 0===e?void 0:e.entity})}catch(t){console.warn(`Flower card: Failed to fetch data for ${null===(i=this.config)||void 0===i?void 0:i.entity}:`,t),this.plantinfo&&this.plantinfo.result&&0!==Object.keys(this.plantinfo.result).length||(this.plantinfo={result:{}})}})}getCardSize(){return 5}static get styles(){return ut}};Ot([ht()],Ut.prototype,"_hass",void 0),Ot([ht()],Ut.prototype,"config",void 0),Ot([pt()],Ut.prototype,"_careDialogOpen",void 0),Ot([pt()],Ut.prototype,"_careDialogFields",void 0),Ot([pt()],Ut.prototype,"_careDialogTitle",void 0),Ot([pt()],Ut.prototype,"_imageDialogOpen",void 0),Ut=Ot([(t=>(e,i)=>{void 0!==i?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)})(_t)],Ut)})();