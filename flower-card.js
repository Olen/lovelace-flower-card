...
let FlowerCard = class FlowerCard extends lit_element_1.LitElement {
    ...
    render() {
        ...
        return (0, lit_element_1.html) `
            <ha-card>
            <div class="header" @click="${() => (0, utils_1.moreInfo)(this.stateObj.entity_id)}">
            ...
            ${(0, attributes_1.renderAttributes)(this.plantinfo, this.config, this._hass)}
            </ha-card>
            `;
    }
    get_data(hass) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.renderAttributes = exports.renderBattery = void 0;
const lit_element_1 = __webpack_require__(156);
...
const renderAttributes = (plantinfo, config, hass) => {
    const icons = {};
    const uom = {};
    const uomt = {};
    const limits = {};
    ...
    const sensors = {};
    const displayed = {};
    const monitored = config.show_bars || constants_1.default_show_bars;
    ...
    const attribute = (attr) => {
        ...
        return (0, lit_element_1.html) `
            <div class="attribute tooltip" @click="${() => (0, utils_1.moreInfo)(attr.sensor)}">
    ...
    return chunkedDisplayed.map((chunk) => {
        return chunk.map((item) => {
            return item ? (0, lit_element_1.html) `<div class="attributes">${attribute(item)}</div>` : '';
        });
    }).flat();
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.missingImage = exports.default_show_bars = exports.CARD_NAME = void 0;
exports.CARD_NAME = "mini-flower-card";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.moreInfo = exports.getStubConfig = exports.getConfigElement = void 0;
...
const moreInfo = (entityId) => {
    (0, custom_card_helpers_1.fireEvent)(this, 'hass-more-info', { entityId }, { bubbles: false, composed: true });
};
